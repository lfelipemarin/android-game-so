...
public class RankActivity extends Activity implements View.OnClickListener {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		System.out.println(Thread.currentThread().getId() + " Creando "
				+ this.getClass());
		enviado = false;
	...
	public void onClick(View arg0) {
		if (!enviado) {
			System.out.println(Thread.currentThread().getId() + " [INFO] "
					+ HASH + " " + score);
			...
			if (enviarScore.enviado) {
				...
				if (pedirTop.enviado) {
					...
					treceptor.start();
					System.out.println(Thread.currentThread().getId()
							+ " Hijo " + treceptor.getId()
							+ " lanzado esperando top.");
					try {
						treceptor.join();
						System.out.println(Thread.currentThread().getId()
			...
			System.out.println(Thread.currentThread().getId() + " El  score ya fue enviado cobbidbp.");
		}
	}

	@Override
	protected void onDestroy() {
		System.out.println(Thread.currentThread().getId() + " Destruyendo "
				+ this.getClass());
		super.onDestroy();
	}
	...
	protected void onPause() {
		System.out.println(Thread.currentThread().getId() + " Pausando "
				+ this.getClass());
		super.onPause();
	}
	...
	protected void onStop() {
		System.out.println(Thread.currentThread().getId() + " Parando "
				+ this.getClass());
		super.onStop();
	}
	...
	protected void onRestart() {
		System.out.println(Thread.currentThread().getId() + " Reniniciando "
				+ this.getClass());
		super.onRestart();
	}
}
